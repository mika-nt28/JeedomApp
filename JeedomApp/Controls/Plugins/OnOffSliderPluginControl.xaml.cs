...
{
    public sealed partial class OnOffSliderPluginControl : UserControl
    {
        #region Public Fields

        public static readonly DependencyProperty OffBrushProperty =
            DependencyProperty.Register("OffBrush", typeof(Brush), typeof(OnOffSliderPluginControl), new PropertyMetadata(XamlBindingHelper.ConvertValue(typeof(Brush), "#FF434A54")));

        public static readonly DependencyProperty OffIconProperty =
            DependencyProperty.Register("OffIcon", typeof(string), typeof(OnOffSliderPluginControl), new PropertyMetadata("\uf00d"));

        public static readonly DependencyProperty OffProperty =
            DependencyProperty.Register("Off", typeof(Command), typeof(OnOffSliderPluginControl), new PropertyMetadata(null));

        public static readonly DependencyProperty OnBrushProperty =
            DependencyProperty.Register("OnBrush", typeof(Brush), typeof(OnOffSliderPluginControl), new PropertyMetadata(XamlBindingHelper.ConvertValue(typeof(Brush), "#FF8CC152")));

        public static readonly DependencyProperty OnIconProperty =
                    DependencyProperty.Register("OnIcon", typeof(string), typeof(OnOffSliderPluginControl), new PropertyMetadata("\uf00c"));

        public static readonly DependencyProperty OnProperty =
            DependencyProperty.Register("On", typeof(Command), typeof(OnOffSliderPluginControl), new PropertyMetadata(null));

        public static readonly DependencyProperty StateBoolProperty =
            DependencyProperty.Register("StateBool", typeof(bool), typeof(OnOffSliderPluginControl), new PropertyMetadata(false));

        public static readonly DependencyProperty StateBrushProperty =
                    DependencyProperty.Register("StateBrush", typeof(Brush), typeof(OnOffSliderPluginControl), new PropertyMetadata(null));

        public static readonly DependencyProperty StateIconProperty =
            DependencyProperty.Register("StateIcon", typeof(string), typeof(OnOffSliderPluginControl), new PropertyMetadata("\uf00d"));

        public static readonly DependencyProperty StateProperty =
            DependencyProperty.Register("State", typeof(Command), typeof(OnOffSliderPluginControl), new PropertyMetadata(null));
        ...
        public OnOffSliderPluginControl()
        {
