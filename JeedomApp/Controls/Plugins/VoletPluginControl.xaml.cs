...
{
    public sealed partial class VoletPluginControl : UserControl
    {
        #region Public Fields

       
        public static readonly DependencyProperty SilderProperty =
            DependencyProperty.Register("FLAP_SLIDER", typeof(Command), typeof(VoletPluginControl), new PropertyMetadata(null));

        public static readonly DependencyProperty DownProperty =
            DependencyProperty.Register("FLAP_DOWN", typeof(Command), typeof(VoletPluginControl), new PropertyMetadata(null));

        public static readonly DependencyProperty StopProperty =
             DependencyProperty.Register("FLAP_STOP", typeof(Command), typeof(VoletPluginControl), new PropertyMetadata(null));

        public static readonly DependencyProperty UpProperty =
             DependencyProperty.Register("FLAP_UP", typeof(Command), typeof(VoletPluginControl), new PropertyMetadata(null));

        public static readonly DependencyProperty StateProperty =
            DependencyProperty.Register("FLAP_STATE", typeof(string), typeof(VoletPluginControl), new PropertyMetadata(null));
